...
import { LayoutDashboard, ClipboardList, Video, Activity, CreditCard, MessageSquare, Bell, Dumbbell } from "lucide-react";

const navItems = [
  { href: "/client/dashboard", label: "Dashboard", icon: LayoutDashboard },
  { href: "/client/checkin", label: "Check-In", icon: ClipboardList },
  { href: "/client/program", label: "My Program", icon: Dumbbell },
  { href: "/client/videos", label: "Form Videos", icon: Video },
  { href: "/client/progress", label: "Progress", icon: Activity },
